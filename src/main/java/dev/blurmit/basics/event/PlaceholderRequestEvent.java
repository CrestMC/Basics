package dev.blurmit.basics.event;
...
public class PlaceholderRequestEvent extends Event implements Cancellable {
    ...
    public PlaceholderRequestEvent(String placeholder, Player player, Command command, String[] arguments, Object[] replacements, boolean async) {
        super(async);
    ...
    public PlaceholderRequestEvent(String placeholder, CommandSender sender, Command command, String[] arguments, Object[] replacements, boolean async) {
        super(async);
        this.placeholder = placeholder;
        this.cancelled = false;
        this.sender = sender;
