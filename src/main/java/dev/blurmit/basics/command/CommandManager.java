...
import dev.blurmit.basics.util.Reflector;
import dev.blurmit.basics.util.lang.Prefixes;
...
public class CommandManager {
    ...
    public void registerCommands() {
        Reflector.consume("dev.blurmit.basics.command.defined", Basics.class.getClassLoader(), CommandBase.class, CommandBase::registerCommand, true, plugin);
    }
