...
public class Scoreboards {
    ...
    public Scoreboards getNew() {
        objective.setDisplayName(Placeholders.parsePlaceholder(Basics.getInstance().getConfigManager().getScoreboardConfig().getString("title")));

        Basics.getInstance().getConfigManager().getScoreboardConfig().getStringList("entries").forEach(entry -> {
