...
public class WalkSpeedCommand extends CommandBase {
    ...
    public boolean execute(CommandSender sender, @NotNull String commandLabel, String[] args) {
        ...
        if (args.length == 2) {
            ...
            sender.sendMessage(Placeholders.parse(Messages.WALK_SPEED_CHANGED + "", target, this, args));
            return true;
        ...
        if (args.length == 1) {
            ...
            if (speed > 10F || speed < -10F) {
                sender.sendMessage(Placeholders.parse(Messages.WALK_SPEED_INVALID + "", player, this, args));
                return true;
            }

            player.setWalkSpeed(speed / 10F);
            player.sendMessage(Placeholders.parse(Messages.WALK_SPEED_CHANGED + "", player, this, args));
            return true;
        }
